...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            doc.open();
            Image img = Image.getInstance(getClass().getResource("/Img/newUser.png"));
            //Fecha
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    Encabezado.addCell("IDE:    " + rs.getString("idee") + "\nNOMBRE: " + rs.getString("nombre")
            ...
            PdfPCell cliDir = new PdfPCell(new Phrase("DIRECCION", negrita));
            ...
            PdfPCell c2 = new PdfPCell(new Phrase("NOM. PRODUCTO", negrita));
            PdfPCell c3 = new PdfPCell(new Phrase("P/U.", negrita));
            ...
            info.add("TOTAL VENTA: $" + total);
            info.setAlignment(Element.ALIGN_RIGHT);
            doc.add(info);
            Paragraph firma = new Paragraph();
            firma.add(Chunk.NEWLINE);
            firma.add("CACELACION \n\n");
            firma.add("------------------------------------\n");
            firma.add("FIRMA DEL ADMIN \n");
